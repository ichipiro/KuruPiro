...
export default function BusCardList({ busId, via, scheduledTime, delayedTime, remainingSeconds, isRecommended = false }: BusCardProps) {
  ...
  return (
    <div className={`relative rounded-[1.5vw] ${isDelayed ? 'bg-[#FFE5E5]' : 'bg-white'} w-[26vw] h-[7.5vw] px-[1.2vw] flex flex-col justify-center overflow-hidden ${isRecommended ? 'border-r-[0.6vw] border-[#FFCB00]' : ''}`}>
      <div>
